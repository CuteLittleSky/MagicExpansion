...
public enum Fish {
    ...
    TestFish(Rarity.RARE.colorCode+"测试鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("铜粉鱼体重大多都在 1 - 16 kg之间。")
    ),
    ...
    CopperDustFish(Rarity.RARE.colorCode+"赤鳞鱼", 1.0, 16.0, Rarity.RARE,
            ColorGradient.getGradientName("闪烁着金属光泽的小鱼，游动时会洒下细碎的铜色光点。"),
            ColorGradient.getGradientName("传说它由古老的铜矿渗水孕育而成，只在富含矿物质的水域存活。"),
            ColorGradient.getGradientName("可在生态缸中进行稳定生产。"),
            ColorGradient.getGradientName("铜粉鱼体重大多都在 1 - 16 kg之间。"),
    ...
    CoalFish(Rarity.RARE.colorCode + "煤晶鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("煤晶鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：煤炭")
    ),
    // 【EmeraldFish】用于生产：绿宝石（Emerald）
    EmeraldFish(Rarity.RARE.colorCode + "翠宝鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("翠宝鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：绿宝石")
    ),
    // 【LapisFish】用于生产：青金石（Lapis Lazuli）
    LapisFish(Rarity.RARE.colorCode + "靛灵鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("靛灵鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：青金石")
    ),
    // 【DiamondFish】用于生产：钻石（Diamond）
    DiamondFish(Rarity.RARE.colorCode + "晶耀鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("晶耀鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：钻石")
    ),
    // 【QuartzFish】用于生产：下界石英（Nether Quartz）
    QuartzFish(Rarity.RARE.colorCode + "焰晶鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("焰晶鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：下界石英")
    ),
    // 【IronFish】用于生产：铁锭（Iron Ingot）
    IronFish(Rarity.RARE.colorCode + "铁核鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("铁核鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：铁锭")
    ),
    // 【GoldFish】用于生产：金锭（Gold Ingot）
    GoldFish(Rarity.RARE.colorCode + "鎏核鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("鎏核鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：金锭")
    ),
    // 【CopperFish】用于生产：铜锭（Copper Ingot）
    CopperFish(Rarity.RARE.colorCode + "铜脉鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("铜脉鱼体重大多都在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：铜锭")
    ),
    // 【脉动鱼】用于生产：红石粉（Redstone Dust）
    RedstoneFish(Rarity.RARE.colorCode + "赤脉鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("脉动鱼体重多在 1 - 16 kg 之间，脉冲频率越高，红石纯度越佳。"),
            ColorGradient.getGradientName("「特殊作用」可生产：红石粉")
    ),
    // 【GlowStoneFish】用于生产：萤石粉（Glowstone Dust）
    GlowStoneDustFish(Rarity.RARE.colorCode + "灯笼鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("灯笼鱼体重大多在 1 - 16 kg 之间，轻盈如雾。"),
            ColorGradient.getGradientName("「特殊作用」可生产：萤石粉"),
            ColorGradient.getGradientName("「特殊作用」可用于发电")
    ),

    // 【塑灵鱼】用于生产：塑料纸（Plastic Paper）
    ShuLingYu(Rarity.RARE.colorCode + "塑灵鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("塑灵鱼体重大多在 1 - 16 kg 范围内。"),
            ColorGradient.getGradientName("「特殊作用」可生产：塑料纸")
    ),
    // 【铀核鱼】用于生产：铀锭（Uranium Ingot）
    UraniumFish(Rarity.RARE.colorCode + "铀核鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("铀核鱼体重通常在 1 - 16 kg 之间。"),
            ColorGradient.getGradientName("「特殊作用」可生产：铀锭")
    ),
    // 【油岩鱼】用于生产：原油桶（Crude Oil Barrel）
    OilRockFish(Rarity.RARE.colorCode + "油岩鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("油岩鱼体重普遍在 1 - 16 kg 范围内。"),
            ColorGradient.getGradientName("「特殊作用」可生产：原油桶")
    ),
    // 【黑曜鱼】用于生产：黑金刚石（Black Diamond）
    BlackDiamondFish(Rarity.EPIC.colorCode + "黑曜鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("黑曜鱼体重可达 1 - 16 kg，越重者晶化程度越高。"),
            ColorGradient.getGradientName("「特殊作用」可生产：黑金刚石")
    ),
    // 【酸晶鱼】用于生产：硫酸盐（Sulfate Crystals）
    SulfateFish(Rarity.RARE.colorCode + "酸晶鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("酸晶鱼体重一般在 1 - 16 kg 范围内。"),
            ColorGradient.getGradientName("「特殊作用」可生产：硫酸盐")
    ),
    // 【晶鳞鱼】用于生产：硅（Silicon）
    SiliconFish(Rarity.RARE.colorCode + "晶鳞鱼", 1.0, 16.0, Rarity.RARE,
            ...
            ColorGradient.getGradientName("晶鳞鱼体重多在 1 - 16 kg 之间，越老者硅化程度越高。"),
            ColorGradient.getGradientName("「特殊作用」可生产：硅")
    ),
    // 【灵咒鱼】用于生产：附魔瓶（Bottled Enchanting）
    EnchantedBottleFish(Rarity.EPIC.colorCode + "灵咒鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("灵咒鱼体重多在 1 - 16 kg 之间，越老者灵咒程度越高。"),
    ...
    // 【硬化灵鱼】用于生产：硬化金属
    HardenedMetalFish(Rarity.EPIC.colorCode + "硬化灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("硬化灵鱼体重多在 1 - 16 kg 之间，越老者釉层越厚。"),
            ColorGradient.getGradientName("「特殊作用」可生产：硬化金属")
    ),

    // 【大马士革灵鱼】用于生产：大马士革钢锭
    DamascusSoulFish(Rarity.EPIC.colorCode + "大马士革灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("大马士革灵鱼体重多在 1 - 16 kg 之间，纹路越繁复者品质越高。"),
            ColorGradient.getGradientName("「特殊作用」可生产：大马士革钢锭")
    ),

    // 【钢魄鱼】用于生产：钢锭
    SteelSoulFish(Rarity.EPIC.colorCode + "钢魄鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("钢魄鱼体重多在 1 - 16 kg 之间，越沉者钢质越密。"),
            ColorGradient.getGradientName("「特殊作用」可生产：钢锭")
    ),

    // 【青铜古影鱼】用于生产：青铜锭
    BronzeAncientFish(Rarity.EPIC.colorCode + "青铜古影鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("青铜古影鱼体重多在 1 - 16 kg 之间，越古者锈色越深。"),
            ColorGradient.getGradientName("「特殊作用」可生产：青铜锭")
    ),

    // 【硬铝天翔鱼】用于生产：硬铝锭
    HardlightAluFish(Rarity.EPIC.colorCode + "硬铝天翔鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("硬铝天翔鱼体重多在 1 - 16 kg 之间，越轻盈者越接近完美合金。"),
            ColorGradient.getGradientName("「特殊作用」可生产：硬铝锭")
    ),

    // 【银铜灵鱼】用于生产：银铜合金锭
    SilverCopperFish(Rarity.EPIC.colorCode + "银铜灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("银铜灵鱼体重多在 1 - 16 kg 之间，越亮者纯度越高。"),
            ColorGradient.getGradientName("「特殊作用」可生产：银铜合金锭")
    ),

    // 【黄铜鸣音鱼】用于生产：黄铜锭
    BrassResonanceFish(Rarity.EPIC.colorCode + "黄铜鸣音鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("黄铜鸣音鱼体重多在 1 - 16 kg 之间，嗡鸣越纯者品质越佳。"),
            ColorGradient.getGradientName("「特殊作用」可生产：黄铜锭")
    ),

    // 【铝黄铜灵鱼】用于生产：铝黄铜锭
    AluminumBrassFish(Rarity.EPIC.colorCode + "铝黄铜灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("铝黄铜灵鱼体重多在 1 - 16 kg 之间，越热越活跃。"),
            ColorGradient.getGradientName("「特殊作用」可生产：铝黄铜锭")
    ),

    // 【铝青铜灵鱼】用于生产：铝青铜锭
    AluminumBronzeFish(Rarity.EPIC.colorCode + "铝青铜灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("铝青铜灵鱼体重多在 1 - 16 kg 之间，光泽越稳定者合金越纯净。"),
            ColorGradient.getGradientName("「特殊作用」可生产：铝青铜锭")
    ),

    // 【科林斯青铜灵鱼】用于生产：科林斯青铜锭
    CorinthianBronzeFish(Rarity.EPIC.colorCode + "科林斯青铜灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("科林斯青铜灵鱼体重多在 1 - 16 kg 之间，纹路越繁复越珍贵。"),
            ColorGradient.getGradientName("「特殊作用」可生产：科林斯青铜锭")
    ),

    // 【镍魄鱼】用于生产：镍锭
    NickelSpiritFish(Rarity.EPIC.colorCode + "镍魄鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("镍魄鱼体重多在 1 - 16 kg 之间，磁性越强者越稀有。"),
            ColorGradient.getGradientName("「特殊作用」可生产：镍锭")
    ),

    // 【钴焰鱼】用于生产：钴锭
    CobaltFlameFish(Rarity.EPIC.colorCode + "钴焰鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("钴焰鱼体重多在 1 - 16 kg 之间，火焰越盛者能量越强。"),
            ColorGradient.getGradientName("「特殊作用」可生产：钴锭")
    ),

    // 【硅铁灵鱼】用于生产：硅铁
    SiliconIronFish(Rarity.EPIC.colorCode + "硅铁灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("硅铁灵鱼体重多在 1 - 16 kg 之间，越规整者纯度越高。"),
            ColorGradient.getGradientName("「特殊作用」可生产：硅铁")
    ),

    // 【碳魂鱼】用于生产：碳块
    CarbonSoulFish(Rarity.EPIC.colorCode + "碳魂鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("碳魂鱼体重多在 1 - 16 kg 之间，越黑越密实者越珍贵。"),
            ColorGradient.getGradientName("「特殊作用」可生产：碳块")
    ),

    // 【镀金灵鱼】用于生产：镀金铁锭
    GildedIronFish(Rarity.EPIC.colorCode + "镀金灵鱼", 1.0, 16.0, Rarity.EPIC,
            ...
            ColorGradient.getGradientName("镀金灵鱼体重多在 1 - 16 kg 之间，金层越厚越稀有。"),
