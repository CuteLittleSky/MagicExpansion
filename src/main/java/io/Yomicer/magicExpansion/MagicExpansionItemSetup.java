...
//        registerUIBlockInContribution(MagicExpansionItems.UI_4,plugin);
        ...
        new FishingRod(magicexpansionfishing, MagicExpansionItems.FISHING_ROD_WIND_SPEAKER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
            ...
            put(Enchantment.LURE, 5);
                ...
                Map.of(
                        "magic_sugar", List.of(
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_1, 30),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_2, 30),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_3, 8),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_4, 8),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_5, 8),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_6, 6),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_7, 6),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_8, 6),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_9, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_10, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_11, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_12, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_13, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_14, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_15, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_16, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_17, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_18, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_19, 4),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_20, 2),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_21, 2),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_22, 2),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_23, 2),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_24, 2),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_25, 1),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_26, 1),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_27, 1),
                                new WeightedItem(MAGIC_EXPANSION_MAGIC_SUGAR_28, 1),
                                ...
                                new WeightedItem(SlimefunItems.MAGIC_LUMP_1, 30),
                                new WeightedItem(SlimefunItems.MAGIC_LUMP_2, 30),
                                new WeightedItem(SlimefunItems.MAGIC_LUMP_3, 80),
                                new WeightedItem(SlimefunItems.ENDER_LUMP_1, 30),
                                new WeightedItem(SlimefunItems.ENDER_LUMP_2, 30),
                                new WeightedItem(SlimefunItems.ENDER_LUMP_3, 80),
